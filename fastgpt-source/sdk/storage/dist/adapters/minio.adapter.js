...
import { CreateBucketCommand, DeleteBucketLifecycleCommand, NotFound, PutBucketPolicyCommand } from '@aws-sdk/client-s3';
 ...
 */
export class MinioStorageAdapter extends AwsS3StorageAdapter {
    options;
    minioClient;
    constructor(options) {
    ...
    async ensurePublicBucketPolicy() {
        const policy = {
            Version: '2012-10-17',
            Statement: [
                {
