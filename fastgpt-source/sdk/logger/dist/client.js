...
export async function configureLogger(options = {}) {
    ...
    configurePromise = (async () => {
        ...
        const contextLocalStorage = options.contextLocalStorage ?? new AsyncLocalStorage();
        await configure({
            contextLocalStorage,
            loggers,
            sinks
...
export function getLogger(category = defaultCategory) {
            ...
            return (...args) => {
                ...
                if (typeof firstArg === 'string') {
                    if (typeof secondArg === 'object' &&
                        ...
                        !secondArg.verbose) {
                        const { verbose: _verbose, ...properties } = secondArg;
