...
#define PACKAGE_STRING "PostgreSQL 15.15"
...
#define PG_VERSION "15.15"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 150015

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 15.15, compiled by Visual C++ build " CppAsString2(_MSC_VER) ", 64-bit"
